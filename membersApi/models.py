...
class Member(AbstractUser):
    ...
    slack = models.CharField(max_length=50, verbose_name='@Slack', blank=True, null=True)
    phone = models.CharField(max_length=20, verbose_name='Celular', blank=True, null=True)
